...
import { PaidInvoicesPage } from './admin/pages/PaidInvoicesPage';
import { CompletedOrdersPage } from './admin/pages/CompletedOrdersPage';
import { CancelledItemsPage } from './admin/pages/CancelledItemsPage';
import { CommissionPayoutsPage } from './admin/pages/CommissionPayoutsPage';
      ...
      <div className="min-h-screen bg-[#0a0514]">
        ...
        <Routes>
          ...
          <Route path="/admin" element={<RequireAuth allowedRoles={['admin']}><AdminLayout /></RequireAuth>}>
            ...
            {/* Accounting */}
            <Route path="accounting/paid-invoices" element={<PaidInvoicesPage />} />
            <Route path="accounting/completed-orders" element={<CompletedOrdersPage />} />
            <Route path="accounting/cancelled-items" element={<CancelledItemsPage />} />
            <Route path="accounting/commission-payouts" element={<CommissionPayoutsPage />} />
          </Route>
