  ...
  const renderOverview = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="bg-brand-800 border-brand-700 cursor-pointer hover:border-white/30 transition-colors" onClick={() => setActiveTab('orders')}>
        ...
        <Card className="bg-brand-800 border-brand-700 cursor-pointer hover:border-yellow-400/40 transition-colors" onClick={() => setActiveTab('invoices')}>
          <CardHeader className="pb-2">
        ...
        <Card className="bg-brand-800 border-brand-700 cursor-pointer hover:border-red-400/40 transition-colors" onClick={() => setActiveTab('invoices')}>
          <CardHeader className="pb-2">
